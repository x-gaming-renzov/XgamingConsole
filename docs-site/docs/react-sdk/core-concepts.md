...
All API calls require an `apiKey` for authentication. This key identifies the organisation and app context for your SDK integration.
...
- Provider config: `apiKey`, `apiEndpoint`, `registry`
